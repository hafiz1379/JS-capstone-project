...
**JS Capstone Project** In this group project we have created a website where customers can view movies, make comments and book the movies that are in stock.
...
Feel free to check the [issues page](https://github.com/hafiz1379/JS-capstone-project/issues)
...
## 📝 License
This project is [MIT](https://github.com/hafiz1379/JS-capstone-project/blob/Development/LICENSE) licensed.